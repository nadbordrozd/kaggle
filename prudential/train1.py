...
all_data = xtrain.append(test)

# factorize categorical variables    
all_data['Product_Info_2'] = pd.factorize(xall_data['Product_Info_2'])[0]
...
all_data['Response'] = xall_data['Response'].astype(int)

# Provide split column
# all_data['Split'] = np.random.randint(5, size=all_data.shape[0])

# split train and test
train = xall_data[xall_data['Response']>0].copy()
test = xall_data[xall_data['Response']<1].copy()
